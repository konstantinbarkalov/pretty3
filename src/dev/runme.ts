...
const ansiOutput = Pretty.stringify(tree, undefined, {renderer: ansiRenderer});
const htmlOutput = Pretty.stringify(tree, undefined, {renderer: htmlRenderer});
const plainOutput = Pretty.stringify(tree, undefined, {renderer: plainRenderer});
